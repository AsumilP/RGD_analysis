...
%% Parameters 1
      ...
      frames=39; %the number of frames you will convert
      first_frame=1; %select the first frame
      skip_frame = 0; %the number of skip frame

      filename = sprintf('plif_11_difabs_12.dat');  %convert from, under the same directory
      gifname= './plif_20190301_11_difabs_12.gif';  %convert into, under the same directory
...
%         fseek(fid,(first_frame-1)*Pixels*2,'bof');  % 2 Byte, binarize...
        ...
        for idx=1:1:frames
%             I = fread(fid2,Pixels,'uint16');  % 2 Byte
