...
!!  character(*), parameter:: file_name_head_particle = file_name_head
  ...
  character(*), parameter:: path_of_coe = '/home/yatagi/mnt/20201221/imgcor/grid/' !output
  ...
  character(*), parameter:: file_name_rawi = 'spiv_bl_07'  !for cold flow
  ...
  character(*), parameter:: file_name_rawo  = 'spiv_bl_07_cor' !output name
