...
!c--------------------------------------------------c
 ...
 integer, parameter :: nvec_x_cut= 114
 ...
 character(*), parameter :: path_of_velo = '/home/yatagi/analysis/piv_output/velofield/20190301/piv/br/'
...
!-------------------------------------------------
 ...
 do l=1,cond
  !-----------------input-------------------
  write(file_name_uraw,"('spiv_br_',i2.2,'_ucut.dat')"),l
!  write(file_name_uraw,"('spiv_br_',i2.2,'_rmv_ucut.dat')"),l
  write(file_name_vraw,"('spiv_br_',i2.2,'_vcut.dat')"),l
!  write(file_name_vraw,"('spiv_br_',i2.2,'_rmv_vcut.dat')"),l

  !-----------------output-------------------
  write(file_name_ulpf,"('spiv_br_',i2.2,'_ucl.dat')"),l
!  write(file_name_ulpf,"('spiv_br_',i2.2,'_rmv_ucl.dat')"),l
  write(file_name_vlpf,"('spiv_br_',i2.2,'_vcl.dat')"),l
!  write(file_name_vlpf,"('spiv_br_',i2.2,'_rmv_vcl.dat')"),l
