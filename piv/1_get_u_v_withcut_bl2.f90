...
!c--------------------------------------------------c
 ...
 !-----------------------------------
  ...
  do i=1,cond
    write(file_name_out_u,"('spiv_bl_',i2.2,'_u.dat')"),i
    !write(file_name_out_u,"('spiv_bl_',i2.2,'_rmv_u.dat')"),i

    write(file_name_out_v,"('spiv_bl_',i2.2,'_v.dat')"),i
    !write(file_name_out_v,"('spiv_bl_',i2.2,'_rmv_v.dat')"),i

    write(file_name_out_ucut,"('spiv_bl_',i2.2,'_ucut.dat')"),i
    !write(file_name_out_ucut,"('spiv_bl_',i2.2,'_rmv_ucut.dat')"),i

    write(file_name_out_vcut,"('spiv_bl_',i2.2,'_vcut.dat')"),i
    !write(file_name_out_vcut,"('spiv_bl_',i2.2,'_rmv_vcut.dat')"),i

    do j=1,10
      write(file_name_in,"('spiv_bl_',i2.2,'_velo',i0,'.dat')"),i,j
      !write(file_name_in,"('spiv_bl_',i2.2,'_rmv_velo',i0,'.dat')"),i,j
