...
%     col_max=1000; %PLIF
    ...
    file_image=sprintf('D:/chem_output/%d/chem_rmv/chem_%02u_rmv.dat',date,num);
%     file_image=sprintf('D:/plif_output/%d/plif_med/plif_%02u_med.dat',date,num);
    ...
    file_max=sprintf('D:/chem_output/%d/chem_rmv/phasemean/phasemean_max_%d_%d_%02u.dat',date,flow_rate,date,num);
    file_infdown=sprintf('D:/chem_output/%d/chem_rmv/phasemean/phasemean_infdown_%d_%d_%02u.dat',date,flow_rate,date,num);
    file_min=sprintf('D:/chem_output/%d/chem_rmv/phasemean/phasemean_min_%d_%d_%02u.dat',date,flow_rate,date,num);
    file_infup=sprintf('D:/chem_output/%d/chem_rmv/phasemean/phasemean_infup_%d_%d_%02u.dat',date,flow_rate,date,num);
...
%     file_infup=sprintf('D:/plif_output/%d/plif_med/phasemean/phasemean_infup_%d_%d_%02u.dat',date,flow_rate,date,num);
    ...
    savedirectory=sprintf('D:/chem_output/%d/chem_rmv/phasemean/figure/%02u/',date,num); %pictures
