...
% Set arrow size (1= full length of vector), CHANGED 20190728
arrow=0.40;
...
if refvec
 ...
 % Set x position of reference vector, CHANGED 20190728
 xend=xp2-3*padx;
 xstart=xend-scalelength;

 % Plot reference text in lower right hand corner, CHANGED 20190728
 ht=text(xstart,yp1+pady,reftext,'Visible','off','FontSize',15,...
        'FontName','Times New Roman','VerticalAlignment','Bottom','HorizontalAlignment','Right');
 textextent=get(ht,'Extent');

 % Draw patch over area of vector key, CHANGED 20190728
 xl=textextent(1)-2.5*padx;
 xr=xp2;
 yb=yp1;
 ...
 % Redraw reference text on top of patch, CHANGED 20190728
 ht=text(xstart,(yb+yt)/2,2.1,reftext,'FontSize',15,...
         'FontName','Times New Roman','VerticalAlignment','Middle','HorizontalAlignment','Right');
