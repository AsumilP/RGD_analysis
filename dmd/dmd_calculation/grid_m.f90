...
!----------------------------------------------------------------------!
  ...
  parameter (dir_in = '/home/yatagi/analysis/piv_output/velofield/dmd/20201223/data_files/')
  parameter (dir_out = '/home/yatagi/analysis/piv_output/velofield/dmd/20201223/01/averaging/u/13_13/') ! CHECK,directory
  ! parameter (dir_out = '/home/yatagi/analysis/piv_output/velofield/dmd/20201223/01/averaging/v/01_13/') ! CHECK,directory
  ...
  parameter (case_name = 'spiv_fbsc_01_u') ! CHECK,number
