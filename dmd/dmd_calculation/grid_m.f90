...
!----------------------------------------------------------------------!
  ...
  parameter (nx_g = 1024)
  parameter (ny_g = 1024)
  parameter (tsst = 15114 - 0 + 2) !CHECK,start number
  parameter (tsed = 15114 + 2500) !last number
  ...
  parameter (dir_out = '/home/yatagi/analysis/chem_output/dmd/20190819/05/averaging/trans6/3_3/') ! CHECK,directory
