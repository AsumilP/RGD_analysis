...
!----------------------------------------------------------------------!
  ...
  parameter (nx_g = 1024)
  parameter (ny_g = 1024)
  parameter (tsst = 14700 - 0 + 2) !CHECK,start number
  parameter (tsed = 14700 + 2500) !last number
  ...
  parameter (dir_out = '/home/yatagi/analysis/chem_output/dmd/20190820/01/averaging/trans6/3_3/') ! CHECK,directory
