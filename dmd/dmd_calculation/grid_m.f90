...
!----------------------------------------------------------------------!
  ...
  parameter (nx_g = 1024)
  parameter (ny_g = 1024)
  parameter (tsst = 1) !CHECK,start number
  ...
  character(2), parameter :: cond = "01"
  character(4), parameter :: step = "chem"
  character(5), parameter :: divi = "01_05"
  ...
  parameter (dir_out = '/home/yatagi/analysis/chem_output/dmd/'//date//'/'//cond//'/averaging/'//step//'/'//divi//'/') ! CHECK,directory
