...
!----------------------------------------------------------------------!
  ...
  parameter (nx_g = 1024)
  parameter (ny_g = 1024)
  parameter (tsst = 16097 - 0 + 2) !CHECK,start number
  parameter (tsed = 16097 + 2500) !last number
  ...
  parameter (dir_out = '/home/yatagi/analysis/chem_output/dmd/20190823/04/averaging/trans6/3_3/') ! CHECK,directory
  ! parameter (case_name = 'spiv_fbsc_10_ucl') ! CHECK,number
  ! parameter (case_name = 'spiv_fbsc_01_vcl') ! CHECK,number
  parameter (case_name = 'chem_04_rmv') ! CHECK,number
