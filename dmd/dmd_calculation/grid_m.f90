...
!----------------------------------------------------------------------!
  ...
  character(2), parameter :: cond = "07"
  character(4), parameter :: step = "chem"
  character(5), parameter :: divi = "05_05"
  ...
  parameter (dir_in = '/home/yatagi/analysis/chem_output/chem_dmd/'//date//'/data_files/')
  parameter (dir_out = '/home/yatagi/analysis/chem_output/chem_dmd/'//date//'/'//cond//'/averaging/'//step//'/'//divi//'/') ! CHECK,directory
  ...
  parameter (case_name = 'chem_'//cond//'_cor') ! CHECK,number
