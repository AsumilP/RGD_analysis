...
!----------------------------------------------------------------------!
  ...
  parameter (nx_g = 1024)
  parameter (ny_g = 1024)
  parameter (tsst = 15397 - 0 + 2) !CHECK,start number
  parameter (tsed = 15397 + 2500) !last number
  ...
  parameter (dir_in = '/home/yatagi/analysis/chem_output/dmd/20190821/data_files/')
  parameter (dir_out = '/home/yatagi/analysis/chem_output/dmd/20190821/09/averaging/trans6/3_3/') ! CHECK,directory
  ! parameter (case_name = 'spiv_fbsc_10_ucl') ! CHECK,number
  ! parameter (case_name = 'spiv_fbsc_01_vcl') ! CHECK,number
  parameter (case_name = 'chem_09_rmv') ! CHECK,number
