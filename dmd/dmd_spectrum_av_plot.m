...
% %     step6 = 'trans6';
    ...
    dir = 'I:/Analysis/piv_output/dmd/dmd_averaged/';
...
%     loglog(fg1,norm1,'-vr','MarkerSize',8,'MarkerFaceColor','w','MarkerIndices',1:1:length(norm1))
    loglog(fg1,norm1,'-xk','MarkerSize',8,'MarkerFaceColor','w','MarkerIndices',1:1:length(norm1))
...
%      loglog(fg2,norm2,'-sb','MarkerSize',8,'MarkerFaceColor','w','MarkerIndices',1:1:length(norm2))
     loglog(fg2,norm2,'-pr','MarkerSize',8,'MarkerFaceColor','w','MarkerIndices',1:1:length(norm2))
%      loglog(fg2,norm2,'-xk','MarkerSize',8,'MarkerFaceColor','w','MarkerIndices',1:1:length(norm2))
     hold on
     
%      loglog(fg3,norm3,'-dk','MarkerSize',8,'MarkerFaceColor','w','MarkerIndices',1:1:length(norm3))
...
%      legend('500L/min','450L/min','400L/min','250L/min','FontSize',16,'Location','northwest')
     legend('400L/min','450L/min','FontSize',16,'Location','northwest')
